...
const faqs = [
  {
    question: "What is JPG to Word conversion?",
    answer: "It’s the process of turning text in JPG images into editable Word documents using OCR.",
  },
  {
    question: "Do I need Microsoft Word to use this?",
    answer: "No, you can export as .docx or copy the text to use in any editor.",
  },
  {
...
export default function JpgToWordGuide() {
  return (
  <section className="bg-background text-foreground px-4 py-8 max-w-3xl mx-auto" aria-label="Guide content">
      <SEO
        title="JPG to Word – Free Online OCR Guide"
        description="Convert JPG images to editable Word documents using our secure, client-side OCR tool. Step-by-step instructions, tips, and FAQs."
        canonical="/jpg-to-word"
      />
      <FAQSchema faqs={faqs} />
  <h2 className="text-3xl font-bold mb-4">JPG to Word</h2>
      <section className="mb-6">
        <p>
          Converting JPG images to Word documents lets you edit, share, and repurpose text from photos, scans, or screenshots. Our tool makes it easy, private, and fast—no registration required.
        </p>
      </section>
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">How it works</h2>
        <p>
          The app uses browser-based OCR to detect and extract text from JPG images. You can then copy the text or export it as a Word (.docx) file. All operations are performed locally for maximum privacy.
        </p>
      </section>
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">Step-by-step: JPG to Word</h2>
        <ol className="list-decimal ml-6 space-y-2">
          <li>Go to the <Link to="/jpg-to-word" className="text-link">JPG to Word</Link> page.</li>
          ...
          <li>Review the extracted text. Click “Export” to download as a Word file, or copy to clipboard.</li>
        </ol>
        <p className="mt-2">
          For spreadsheet conversion, see our <Link to="/jpg-to-excel" className="text-link">JPG to Excel</Link> guide. For simple text, see <Link to="/extract-text-from-image" className="text-link">Extract Text from Image</Link>.
        </p>
      </section>
      <section className="mb-6">
        ...
        <table className="w-full border border-border text-sm mb-4">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border border-border px-2 py-1">Word (.docx), copy</td>
              <td className="border border-border px-2 py-1">Word, PDF, etc.</td>
            </tr>
          </tbody>
        </table>
      </section>
      ...
      <nav className="mt-8 text-link">
        <Link to="/extract-text-from-image">Extract Text from Image Guide</Link> | <Link to="/copy-text-from-image">Copy Text from Image Guide</Link> | <Link to="/jpg-to-excel">JPG to Excel Guide</Link>
      </nav>
  </section>
  );
}
